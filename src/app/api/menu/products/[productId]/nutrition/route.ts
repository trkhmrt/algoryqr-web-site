...
export async function PATCH(req: Request, context: { params: Promise<{ productId: string }> }) {
  try {
    ...
    const upstream = await axios.patch(`${API_BASE_URL}/menu/products/${productId}/nutrition`, body, {
