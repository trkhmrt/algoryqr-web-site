  ...
  return (
    <footer className="mt-auto px-8 pb-10 pt-4">
      <div className="mx-auto max-w-xl space-y-3 text-center">
        ...
        {contact ? (
          <p className="text-[0.6rem] tracking-[0.25em] text-[var(--mn-muted)]/70">{contact}</p>
        ) : null}
        <p className="text-[0.6rem] tracking-[0.25em] text-[var(--mn-muted)]/60">
          FİYATLAR TÜRK LİRASIDIR · SERVİS DAHİLDİR
        </p>
        <p className="text-[0.55rem] tracking-[0.2em] text-[var(--mn-muted)]/40">
