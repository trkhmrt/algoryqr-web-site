...
export function DigitalMenuPaywall() {
              ...
              {trial.isLoading || eligibleTrials.isLoading ? (
                ...
                <div className="space-y-3">
                  ...
                  <Button
                    ...
                    className="w-full"
                    onClick={() => router.push(DASHBOARD_ROUTES.accountPackagesHighlight("QR_MENU"))}
                  >
                  ...
                  {needsRenewal ? (
                    <Button
                      ...
                      onClick={() =>
                        router.push(
                          packageId == null
                            ? DASHBOARD_ROUTES.accountPackagesHighlight("QR_MENU")
